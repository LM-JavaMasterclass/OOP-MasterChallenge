...
public class Main {
        ...
        Patty veggie = new Patty(true);
        Patty meat = new Patty(false);
        Bread wheatBread = new Bread("Wheat");


        Hamburger lauraBurger = new Hamburger("Laura Order", whiteBread, veggie,4, .5 );
        lauraBurger.addAddition("Cheese");
        lauraBurger.addAddition("Lettuce");
        lauraBurger.addAddition("Chips");
        lauraBurger.addAddition("Avocado");
        lauraBurger.addAddition("Drink");

        lauraBurger.removeAddition(3);


        lauraBurger.currentOrder();

        HealthyBurger benjoBurger = new HealthyBurger("Benjo order", meat, 5, .5);
        benjoBurger.addAddition("Cheese");
        benjoBurger.addAddition("More Cheese");
        benjoBurger.addAddition("Extra extra cheese");

        benjoBurger.currentOrder();
    }
}
